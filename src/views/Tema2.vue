...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.bloque-fondo3
    ...
    .row.justify-content-center.align-items-center        
      .col-lg-10
        .cajon.color-acento-contenido.p-4.mb-5(data-aos="flip-down")
          p(data-aos="fade-down").mb-0 Dicho lo anterior, este componente aborda, entonces, el conjunto de actividades, organizadas o planeadas en un periodo de tiempo definido, dirigidas hacia los objetivos del sistema de gestión, la minimización o reducción de la posibilidad de ocurrencia de accidentes. Este es estructurado por medio de un documento, en donde se deben explicar cada una de las actividades propuestas con su respectiva descripción del por qué y para qué de la realización de la actividad, los objetivos que se aspira alcanzar; se puede nombrar còmo especificar las responsabilidades del personal, a quienes va dirigida, los indicadores de evaluación, las metas a alcanzar y las fechas específicas de inicio y fin de realización.
    p(data-aos="fade-down") Además, debe contener la forma cómo se abordará o desarrollará la actividad y el cronograma de ejecución, donde se especifiquen las fases, tiempos de realización y dinámicas por desarrollar.
    ...
    p(data-aos="fade-down").mb-5 Hasta ahora se han podido considerar los aspectos que componen un programa de salud y seguridad empresarial, sus tipos, estructuras y desarrollo. Para contextualizar la información y abarcar la legislación del por qué se requiere la implementación del programa dentro de las empresas, ahora conoceremos la normatividad.
        ...
        ol.lista-ol--cuadro.mb-5
          li 
            .lista-ol--cuadro__vineta
              span.text-black A 
            p.mb-0 El Decreto 1072 de 2015, se basa en la estructuración del ámbito laboral, abordando la vigilancia y control de los riesgos laborales.                       
          li 
            .lista-ol--cuadro__vineta
              span.text-black B
            p.mb-0 Resolución 0312 de 2019, esta resolución deroga la Resolución 111 de 2017, así busca definir los estándares mínimos del Sistema de gestión de la Seguridad y Salud en el Trabajo (SG-SST).  

    .row.justify-content-center.align-items-center        
      .col-lg-10
        .cajon.color-acento-contenido.p-4.mb-5(data-aos="flip-down")
          p(data-aos="fade-down").mb-0 Se ha determinado hasta el momento los aspectos del programa de seguridad y la importancia de mantener empleados saludables dentro de la empresa, lo que permitirá mejor desempeño y mayor productividad. Ahora, se desarrollarán los temas relevantes que deben estructurarse dentro del programa como son los planes de emergencia que son requeridos a todas las empresas para poder actuar de manera adecuada ante una calamidad. 
    ...
    .row.justify-content-center.align-items-start.mb-5 
      .col-lg-8
        .cajon.color-primario.p-4.mb-5(data-aos="flip-down")
          p(data-aos="fade-down").mb-0 Cualquier situación repentina e inesperada 	que pueda generar riesgo o posibles accidentes entre los colaboradores, o que pueda, o no, tener afectaciones materiales (en instalaciones, equipos o elementos) se puede tomar como situaciones de emergencia.       
        p(data-aos="fade-down").mb-5 Cada empleador debe conocer la naturaleza de su organización y partiendo de allí, tiene la necesidad de identificar y analizar las posibles situaciones de emergencia que se puedan presentar. Posteriormente se deben buscar acciones a ejecutar en caso de la ocurrencia de uno de estos sucesos.                   
      .col-lg-4
        img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/65.png', alt='')

    p(data-aos="fade-down").mb-5 Para esto debe:
    .row.justify-content-center.align-items-center.mb-5           
      .col-lg-8
        PasosA.color-acento-contenido(tipo="l")
          ...
          .row.justify-content-center.align-items-center
            ...
            .col-lg-9.text-start.order-lg-2.my-3
              p(data-aos="fade-right") Identificar los recursos requeridos por cada riesgo observado y proponer acciones preventivas, como capacitaciones en uso de maquinarias, elementos de protección personal y concientización de toda la planta de personal sobre la importancia de la seguridad y salud en el trabajo.    
          .row.justify-content-center.align-items-center
            .col-lg-9.my-3
              p(data-aos="fade-left") Realizar el plan de emergencia de manera escrita donde se describan las acciones a realizar en caso de que se presenten las emergencias.
            .col-lg-3.my-3
              img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/69.svg', alt='')   

    p(data-aos="fade-down").mb-5 Este plan de emergencia depende del tamaño de la organización, es decir, si es una empresa pequeña su plan debe ser sencillo y adecuado para el nivel de riesgo identificado, siempre buscando proteger a las personas que se puedan ver afectadas, sus instalaciones y/o al medio ambiente. En la Figura 1 se presentan los elementos para la elaboración general de un plan de emergencia. 
          ...
          table
            ...
            tbody
              tr
                ...
                td.text-center Estándares mínimos para la implementación de SG-SST en empresas pequeñas, medianas y grandes.
              tr.text-center
    ...
    p(data-aos="fade-down").mb-5 Las diferentes clases de comité dentro de una organización posibilitan la solución de las diversas situaciones que se pueden presentar. A continuación se exponen algunas de estas clases de comités y su finalidad:
    ...
    .row.justify-content-center.align-items-center        
      .col-lg-10
        .cajon.color-acento-contenido.p-4.mb-5(data-aos="flip-down")
          p(data-aos="fade-down").mb-0 Hasta el momento hemos abordado la importancia de promover el bienestar dentro de las organizaciones, razón por la cual se deben estructurar programas de seguridad y salud en el trabajo; cuando ya se tiene organizado, estructurado y validado, lo más importante para el empleador es que toda la organización participe de manera activa en la ejecución de dicho programa, por este motivo en este apartado hablaremos de las estrategias de divulgación e implementación de campañas que motiven a cada uno de los empleados en las actividades y dinámicas propuestas.                                  
</template>
  ...
  data: () => ({
    datosLineaTiempoB: [
      ...
      },
      {
        titulo: 'Seguridad',
        texto:
          'Son los responsables de custodiar tanto los bienes como las personas en caso de una emergencia. Adicionalmente, despejar áreas de trabajo de los brigadistas como el control del personal y particulares que se encuentren en la empresa.',
